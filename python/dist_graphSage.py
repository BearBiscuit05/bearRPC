...
def main(args):
    ...
    if self:
        ...
        val_mask = th.zeros(g.number_of_nodes())
        test_mask = th.zeros(g.number_of_nodes())
        # train_mask[200000:200000+50000] = 1
        # train_mask[1000000:1000000+50000] = 1
        # train_mask[1500000:1500000+50000] = 1
        # train_mask[2000000:2000000+50000] = 1
        #train_mask[1953170:1953170+100000] = 1
        train_mask = train_mask <= 0.08
        val_mask[100001:200000] = 1
        val_mask = val_mask>0.5
        test_mask[300001:] = 1
        test_mask = test_mask>0.5
        print(train_mask)
        print(val_mask)
        print(test_mask)
        print("=======================================")
        train_nid = dgl.distributed.node_split(train_mask, pb, force_even=True)
        val_nid = dgl.distributed.node_split(val_mask, pb, force_even=True)
        test_nid = dgl.distributed.node_split(test_mask, pb, force_even=True)
    else:
