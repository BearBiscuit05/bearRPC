...
json::Value& ClinetfindValue(json::Value &value, const char *key, json::ValueType type)
{
...
json::Value& ClinetfindValue(json::Value& value, const char* key,
                       json::ValueType type, int32_t id)
{
    try {
        return ClinetfindValue(value, key, type);
    }
